---
name: rka-writer
description: "Draft or revise an academic manuscript only when the user explicitly invokes /rka-writer:rka-writer or explicitly requests this standalone Writer workflow. Do not load for ordinary RKA retrieval, research discussion, coding, project maintenance, or general writing."
